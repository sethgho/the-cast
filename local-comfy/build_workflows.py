...
def build_duo(spec):
    ...
    decode = g.add("VAEDecode", "decode", (560, 950), (400, 80),
                   links={"samples": (sampler, 0, "LATENT", False),
                          "vae": (vae, 0, "VAE", False)},
                   outputs=[("IMAGE", "IMAGE")], collapsed=True)
    # The model inks a panel border and a paper margin whatever the prompt says. Left in: the
    # full render ships as drawn, border and all, rather than being cropped into.
